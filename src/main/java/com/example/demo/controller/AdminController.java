...
public class AdminController {
	...
	public String editArticlePost(@ModelAttribute("article") Crime article, HttpServletRequest request) {		
		Crime newArticle = new CrimeBuilder()
				.withTitle(article.getCrimeType())
				.withConclusion(article.getConclusion())
				.withUpdate(article.getLastUpdate())
				.withForward(article.getForwardTo())
				.withSection(article.getSection())
				.withStatus(article.getCrimeStatus())
				.withAddedBy(article.getAddedBy())
				.build();
	...
	public String editCrimeDetails(@ModelAttribute("article") crimeDetails article, HttpServletRequest request) {		
		crimeDetails newArticle = new crimeDetailsBuilder()
				.withName(article.getName())
				.withAadhar(article.getAadhar())
				.withPan(article.getPan())
				.withEmail(article.getEmail())
				.withMobile(article.getMobile())
